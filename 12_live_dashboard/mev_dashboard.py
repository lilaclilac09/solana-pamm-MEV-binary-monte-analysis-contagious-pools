...
app.layout = html.Div([
    html.H1('Solana pAMM MEV Analysis Dashboard', style={'textAlign': 'center', 'color': '#2c3e50'}),
    html.P('Interactive analysis of Maximum Extractable Value in Solana Proportional Automated Market Makers', 
